...
<table class="table table-bordered table-striped" align="center" id="msglist">
    ...
    {% if page.items %}
        {% for msg in page.items %}
            <tr >
                <td><input type="text" placeholder="cx" class="form-control" id="name{{ msg.id }}" value="{{ msg.cx }}" disabled="disabled"></td>
                <td><input type="text" placeholder="rx" class="form-control" id="phone{{ msg.id }}" value="{{ msg.rx }}" disabled="disabled"></td>
                <td><input type="text" placeholder="title" class="form-control" id="mail{{ msg.id }}" value="{{ msg.title }}" disabled="disabled"></td>
                <td>{% if msg.TbRel %}
